@echo off
REM Script spécial pour VSCode/Roo qui démarre le client MCP Jupyter en mode hors ligne
...
echo Pour utiliser les fonctionnalités nécessitant un serveur Jupyter, utilisez le script start-jupyter-manual.bat.
