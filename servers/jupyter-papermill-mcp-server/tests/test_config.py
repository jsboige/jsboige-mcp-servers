...
class TestMCPConfig:
    ...
    def test_config_validation(self):
        ...
        data = {"papermill": {"timeout": 120}, "logging": {"level": "DEBUG"}}
    ...
    def test_config_from_dict(self):
        ...
        data = {
            "papermill": {"timeout": 45, "output_dir": "/tmp/outputs"},
...
class TestConfigManager:
    ...
    def test_load_config_from_file(self):
        ...
        config_data = {
            "papermill": {"timeout": 240, "output_dir": "/tmp/test_out"},
            "logging": {"level": "DEBUG"},
        }
    ...
    def test_load_config_priority(self):
        ...
        file_config = {"papermill": {"timeout": 200}, "logging": {"level": "WARNING"}}
