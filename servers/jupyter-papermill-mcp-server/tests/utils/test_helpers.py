...
class ExecutionManagerTester:
    ...
    async def wait_for_job_completion(
        self, job_id: str, timeout: float = 30.0, poll_interval: float = 0.1
    ) -> Dict[str, Any]:
        """
...
def create_test_notebook(
    cells: List[Dict[str, Any]], metadata: Optional[Dict[str, Any]] = None
) -> Dict[str, Any]:
    """
...
def assert_job_status_progression(
    job_statuses: List[str], expected_progression: List[str]
):
    """
    ...
    for i, expected_status in enumerate(expected_progression):
        assert (
            job_statuses[i] == expected_status
    ...
    return {
        ...
        "medium": {
            "cells": [
                ...
                {
                    "cell_type": "code",
                    "source": "data = pd.DataFrame({'x': np.random.randn(1000)})",
                },
        ...
        "very_complex": {
            "cells": [
                ...
                {
                    "cell_type": "code",
                    "source": "# Mock symbolic AI setup\nprint('Loading Tweety JARs...')",
                },
                {
                    "cell_type": "code",
                    "source": "# Very complex operations\nfor i in range(1000):\n    pass",
                },
            ],
