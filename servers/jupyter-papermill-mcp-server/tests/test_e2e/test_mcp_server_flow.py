...
class TestMCPProtocol:
    ...
    async def test_invalid_params(self, mcp_client: MCPTestClient):
        ...
        response = await mcp_client.send_request(
            "tools/call",
            {"name": "execute_notebook", "arguments": {}},  # Parametres manquants
        )
...
class TestJupyterTools:
    ...
    async def test_list_kernels_tool(self, mcp_client: MCPTestClient):
        ...
        response = await mcp_client.send_request(
            "tools/call", {"name": "list_kernels", "arguments": {}}
        )
    ...
    @pytest.mark.asyncio
    async def test_create_notebook_tool(
        self, mcp_client: MCPTestClient, temp_output_dir
    ):
        ...
        response = await mcp_client.send_request(
            "tools/call",
            {
                ...
                "arguments": {"notebook_path": notebook_path, "kernel_name": "python3"},
            },
        )
...
class TestNotebookExecution:
    ...
    @pytest.mark.asyncio
    async def test_execute_python_success_notebook(
        self, mcp_client: MCPTestClient, test_notebooks_dir
    ):
        ...
        response = await mcp_client.send_request(
            "tools/call",
            {"name": "execute_notebook", "arguments": {"notebook_path": notebook_path}},
        )
    ...
    @pytest.mark.asyncio
    async def test_execute_python_failure_notebook(
        self, mcp_client: MCPTestClient, test_notebooks_dir
    ):
    ...
    async def test_execute_nonexistent_notebook(self, mcp_client: MCPTestClient):
        ...
        response = await mcp_client.send_request(
            "tools/call",
            {
                ...
                "arguments": {"notebook_path": "/nonexistent/path.ipynb"},
            },
        )
...
class TestNotebookManagement:
    ...
    @pytest.mark.asyncio
    async def test_parameterized_execution(
        self, mcp_client: MCPTestClient, create_temp_notebook
    ):
...
class TestErrorHandling:
    ...
    async def test_tool_execution_timeout(
        ...
        response = await mcp_client.send_request(
            ...
            {
                "name": "execute_notebook",
                "arguments": {"notebook_path": str(notebook_path)},
            },
        )
