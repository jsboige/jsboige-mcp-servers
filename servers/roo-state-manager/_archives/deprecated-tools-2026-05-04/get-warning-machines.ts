/**
 * ARCHIVED 2026-05-04
 * Superseded-by: roosync_inventory(type=machines)
 * Reason: CONS-#443 + #1609
 * This file is dead code — 0 active imports from other source files.
 * Retained for reference only. Safe to delete after 30 days (2026-05-04 + 30).
 */
