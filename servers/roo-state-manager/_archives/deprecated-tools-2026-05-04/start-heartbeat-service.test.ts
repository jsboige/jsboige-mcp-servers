/**
 * ARCHIVED 2026-05-04
 * Tests for deprecated tool — source moved to ../_archives/start-heartbeat-service.ts
 * These tests verify backward compat of dead code. Safe to delete after 30 days.
 */
