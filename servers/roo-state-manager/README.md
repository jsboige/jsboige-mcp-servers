...
## 📋 Liste Complète des Outils MCP (36 outils)

Le roo-state-manager propose **36 outils MCP** organisés en 11 catégories fonctionnelles (après consolidation CONS-1 à CONS-13).
...
**Total : 36 outils MCP** organisés pour couvrir l'ensemble du cycle de vie de gestion des conversations Roo.
