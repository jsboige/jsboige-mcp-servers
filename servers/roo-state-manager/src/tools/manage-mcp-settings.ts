...
// [REMOVED] rebuildTaskIndexFixed — #814 recovery: replaced by tools/maintenance/rebuild-task-index.ts
// The old degraded version only generated task_metadata.json files without SQLite write-back.
// The new version in maintenance/ does full SQLite write-back to fix invisible tasks.
