...
const TOOL_MAPPINGS: Record<string, string> = {
  ...
  // [REMOVED] roosync_approve/reject/apply/rollback_decision — Phase B #1863: backward-compat wrappers, consolidated into roosync_decision
  'roosync_init': 'roosync/roosync_init.ts',
  // [REMOVED] roosync_update/manage_baseline — Phase B #1863: backward-compat wrappers, consolidated into roosync_baseline
  'roosync_diagnose': 'roosync/debug-reset.ts',
  // [REMOVED] roosync_export_baseline — Phase B #1863: backward-compat wrapper, consolidated into roosync_baseline
  // [REMOVED] roosync_collect/publish/apply_config — Phase B #1863: backward-compat wrappers, consolidated into roosync_config
